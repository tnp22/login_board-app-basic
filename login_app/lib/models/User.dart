...
class User{
  ...
  bool? enabled; 
  List<Auth>? authList;
  User({ this.no, this.id, this.username, this.password, this.name, this.email, this.createdAt, this.updatedAt, this.enabled, this.authList = const [], });
  ...
  factory User.fromMap(Map<String, dynamic> map) { 
    return User( no: map['no'], id: map['id']?.toString(), 
    ...
    enabled: map['enabled'], authList: map['authList'] != null
